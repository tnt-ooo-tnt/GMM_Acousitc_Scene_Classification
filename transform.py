...
def mfcc(signal, sample_rate=SAMPLING_RATE, winlen=FRAME_LEN_MS, winstep=INPUT_LEN_MS, preemph=PRE_EMPHASIS_COEF, numcep=DIM_OF_MFCC_FEAT, lowfreq=0, highfreq=None, nfilt=26, nfft=NFFT, ceplifter=22, appendEnergy=True, winfunc=lambda x:numpy.ones((x,)), normalization=0, logscale=0, delta=0):
